 ...
 * @property MaterialType $parent
 * @property MaterialType[] $materialTypes
 * @property MaterialType $revisedRow
 * @property MaterialType[] $materialTypes1
 */
class MaterialType extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'materials' => array(self::HAS_MANY, 'Material', 'MaterialType_id'),
			'parent' => array(self::BELONGS_TO, 'MaterialType', 'Parent_id'),
			'materialTypes' => array(self::HAS_MANY, 'MaterialType', 'Parent_id'),
			'revisedRow' => array(self::BELONGS_TO, 'MaterialType', 'RevisedRow_id'),
			'materialTypes1' => array(self::HAS_MANY, 'MaterialType', 'RevisedRow_id'),
		);
	}
