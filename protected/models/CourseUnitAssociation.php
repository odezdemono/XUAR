...
/**
 * This is the model class for table "course_unit_association".
 *
 * The followings are the available columns in table 'course_unit_association':
 * @property string $id
 ...
 * @property CourseUnit $plannedCourseUnit
 * @property CourseUnit $actedCourseUnit
 */
class CourseUnitAssociation extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CourseUnitAssociation the static model class
	 */
	...
	{
		return 'course_unit_association';
	}
	...
	public function relations()
	{
		...
		return array(
			'plannedCourseUnit' => array(self::BELONGS_TO, 'CourseUnit', 'PlannedCourseUnit_id'),
			'actedCourseUnit' => array(self::BELONGS_TO, 'CourseUnit', 'ActedCourseUnit_id'),
		);
	}
