...
class PersonController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Person']))
		{
			...
			$model->RevisedRow_id=null;
			$model->TippedStatus=1;
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Person']))
		{
			...
			$model2->MiddleName=$model->MiddleName;
			$model2->LastName=$model->LastName;
			$model2->Sex=$model->Sex;
			$model2->BirthDate=$model->BirthDate;
			$model2->BirthPlace=$model->BirthPlace;
			$model2->RevisedRow_id=NULL;
			$model2->TippedStatus=0;
			$model2->DeletedStatus=0;
			$model2->save();
				
			$model->attributes=$_POST['Person'];
			$model->RevisedRow_id=$model2->id;
			if($model->save())
				$this->redirect(array('view','id'=>$model->id));
		}
